...
> **محرر قائمة قنوات التلفزيون متعدد العلامات التجارية** — منصة واحدة لأجهزة Samsung وLG وSony وHisense وغيرها.
...
يمكنك تنظيم ملف قائمة القنوات الذي ينقله التلفزيون إلى USB بصريًا في المتصفح باستخدام **السحب والإفلات**، ثم إعادة تحميله إلى التلفزيون. **يتم الاحتفاظ بالبيانات مؤقتًا (RAM/Temp) أثناء العملية فقط، ولا يتم تخزينها بشكل دائم.**
...
| **Panasonic VIERA** | `svl.db / svl.bin` | 🔄 إصدار تجريبي |
...
- **💡 القوالب الذكية** — قم بتطبيق قوالب عامة / أخبار / رياضة بنقرة واحدة
- **🛠️ منشئ القوالب** — قم بإنشاء قائمتك المثالية وحفظها
...
- **🔍 التحقق التلقائي من الترددات** — يكتشف الترددات القديمة/الخاطئة تلقائيًا (Türksat)
...
- **🌙 سمة داكنة/فاتحة و👁️ وضع عمى الألوان** — واجهة سهلة الاستخدام للجميع
- **🌐 دعم 11 لغة**
- **📊 خصوصية تامة (تحليلات بدون ملفات تعريف الارتباط)** — إحصائيات مدمجة لا تستخدم ملفات تعريف الارتباط أو البيانات الشخصية
- **📱 متجاوب تمامًا** — متوافق مع أجهزة الكمبيوتر المكتبية والأجهزة اللوحية والهواتف المحمولة
...
## 🔌 استخدام واجهة برمجة التطبيقات للمطورين ووكلاء الذكاء الاصطناعي (Developer API)

لم يُصمم هذا المشروع ليكون مجرد موقع ويب فحسب، بل تم تصميمه أيضًا ليكون **واجهة برمجة تطبيقات REST** كاملة يمكن لوكلاء الذكاء الاصطناعي (AI Agents) والمطورين استخدامها مباشرةً عبر الكود.

> 🧑‍💻 **للمطورين:** يمكنكم الاطلاع على وثائق Swagger UI التفاعلية عبر الرابط [tvchanneleditor.onrender.com/api/docs](https://tvchanneleditor.onrender.com/api/docs).
> 
> 🤖 **لوكلاء الذكاء الاصطناعي (ChatGPT، Claude، إلخ):** يمكنكم تزويد الذكاء الاصطناعي بمخطط OpenAPI للنص العادي (Plain-Text) القابل للقراءة آليًا عبر هذا الرابط: [tvchanneleditor.onrender.com/api/openapi.txt](https://tvchanneleditor.onrender.com/api/openapi.txt)



### التحقق من الإصدار والنشر (Version Check)
للتحقق في غضون ثوانٍ مما إذا كان خادم العرض قد نشر أحدث التزامات Github أم لا، أو ما إذا كان لا يزال موجودًا في ذاكرة التخزين المؤقت:
```bash
